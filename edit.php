...
<body>
    ...
    <div class="account-content">
        ...
        <div class="about">
            <p>Authorized ID </p>
            <input class="input-about" id="id" name="id" type="text" disabled="disabled" placeholder=<?=$row['national_id']?> required>
        </div>
        <div class="about">
            <p>Address</p>
            <input class="input-about" id="address" name="address" type="text" disabled="disabled" placeholder=<?=$row['Address']?> required >
        </div>
        <div>
