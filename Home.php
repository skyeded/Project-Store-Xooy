...
<link rel="stylesheet" href="Home.css" media="screen">
  ...
  <body class="u-body u-overlap u-overlap-transparent u-xl-mode" data-lang="en"><header class="u-clearfix u-header" id="sec-f1b7" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction=""><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <h3 class="u-align-center u-headline u-text u-text-1">
          ...
          <input style="border: none; background-color: transparent; font-size: 15px; font-weight: bold; cursor: pointer; margin-bottom:20px; " type="submit" name="Log-out" value="Log Out">
          <input style="border: none; background-color: transparent; font-size: 15px; font-weight: bold; cursor: pointer; margin-left: 20px;  margin-bottom:20px;" type="submit" name="edit" value="Edit Profile">
        </form>
        </h3>
        <?php
